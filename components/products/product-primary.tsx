...
import { WishlistItem } from "@/store/features/wishlistSlice";
    ...
    <p className="rounded-full bg-emerald-500 p-1 text-[8px] font-bold uppercase tracking-wide text-white sm:py-1 sm:px-3">Sale</p>
      ...
      <div className="my-4 mx-auto flex w-full px-3 flex-col items-start justify-between">
        ...
        <div className="flex justify-between w-full">
          ...
          <Button onClick={handleAddToCart}  size={"sm"} className="4xl:h-9 4xl:px-4 4xl:py-2 rounded-full bg-transparent sm:bg-primary md:bg-transparent xl:bg-primary shadow-none">
